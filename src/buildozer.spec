...
source.include_exts = py,png,jpg,kv,atlas,json,wav,mp3,ttf,ogg
...
#source.exclude_dirs = tests, bin, venv, docker, .pytest_cache

# (list) List of exclusions using pattern matching
# Do not prefix with './'
#source.exclude_patterns = license,images/*/*.jpg,*.psd,*.xcf,*.git,*.github,*.txt
